          ...
          {cars.map((product) => (
            <div key={product.id} className="group relative">
              ...
              <div className="mt-4 flex justify-between">
                ...
                <p className="text-sm font-medium text-gray-900">{product.rentalPrice}</p>
              </div>
              <div className="w-full">
                <ul className='flex flex-wrap gap-1 text-gray-400 text-xs'>
                  {cutAddress(product.address).map((el, index) => (    
                  <li key={index}><p>{el}<span> |</span></p></li>
                  ))}
                  <li><p>{product.rentalCompany}<span> |</span></p></li>
                  <li><p>{product.type}<span> |</span></p></li>
                  <li><p>{product.make}<span> |</span></p></li>
                  <li><p>{product.mileage}<span> |</span></p></li>
